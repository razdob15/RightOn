...
export const HebrewMain: React.FC = () => {
  ...
  const tabs = [
    ...
    {
      label: "שירות צבאי", componentFunc: (onSubmit: () => void, onValidityChange: (valid: boolean) => void) =>
        <ArmyQuestions onSubmit={onSubmit} onValidityChange={onValidityChange} />
    },
    {
      label: "דיור", componentFunc: (onSubmit: () => void, onValidityChange: (valid: boolean) => void) =>
